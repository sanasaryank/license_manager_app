const rus = {
  ...
  licenseHistory: {
    ...
    hwid: 'HWID',
    license: 'Лицензия',
    requestIp: 'IP запроса',
    user: 'Пользователь',
    viewRequest: 'Просмотреть запрос лицензии',
    viewGranted: 'Просмотреть выданную лицензию',
    requestTitle: 'Запрос лицензии',
    grantedTitle: 'Выданная лицензия',
